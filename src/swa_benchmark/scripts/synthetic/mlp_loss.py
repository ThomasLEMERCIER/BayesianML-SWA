...
if __name__ == "__main__":
    ...
    training_scheduler = cosineLR(
        epochs=epochs - 1, eta_min=eta_min, eta_max=eta_max, loader_length=len(train_dl)
    )
    ...
    print(
        f"Model 1 test loss: {loss_1:.4f}, Model 2 test loss: {loss_2:.4f}, Model 3 test loss: {loss_3:.4f}"
    )
